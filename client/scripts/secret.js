...
//        $el.append("<p class='col-md-3 author'>" + data[i].name + " says: </p>");
//        $el.append("<p class='col-md-9 post'>" + data[i].message + "</p>");
//        $el.append("<button class='btn btn-danger deleteButton' data-id='" + data[i]._id + "'>DELETE</button>");
//
//    }
//}
//
